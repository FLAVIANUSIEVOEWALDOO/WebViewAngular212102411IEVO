package com.ievo.webviewangular212102411ievo;
...
public class WebAppInterface {
    ...
    public void showNotification(String title, String message) {
        NotificationChannel channel = new NotificationChannel("PooChannel", "PO", NotificationManager.IMPORTANCE_DEFAULT);
    ...
    public void showWhatsApp() {
        String url = "https://api.whatsapp.com/send?phone=+6281545936602";
